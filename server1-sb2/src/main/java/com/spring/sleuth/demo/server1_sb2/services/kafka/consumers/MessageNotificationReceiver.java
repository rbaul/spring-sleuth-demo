...
public class MessageNotificationReceiver {
    ...
    @KafkaListener(containerFactory = KafkaConfig.SOME_MESSAGE_LISTENER, topics = ServerMessagePublisher.$_KAFKA_TOPICS_SERVER_1_SOME_TOPIC)
    public void receive(@Payload Object data, @Headers MessageHeaders messageHeaders) {
        log.info("Message received from KAFKA topic '{}': data '{}', headers '{}'", ServerMessagePublisher.$_KAFKA_TOPICS_SERVER_1_SOME_TOPIC, data, messageHeaders);
    }
